...
class Game {
  ...
  addNets() {
    ...
    setTimeout(() => this.nets.push(new __WEBPACK_IMPORTED_MODULE_1__net_js__["a" /* default */](this.net, this.canvas)), 6000);
    setTimeout(() => this.nets.push(new __WEBPACK_IMPORTED_MODULE_1__net_js__["a" /* default */](this.net, this.canvas)), 10000);
  }
